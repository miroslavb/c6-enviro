...
5. Keep 115200 baud + "Erase whole flash first". A failed half-write is cured by
   **Recover device (erase flash only)** and flashing again.
...
- A healthy cycle logs:
  `C6-ENVIRO v0.1.0 starting (wake #N, deep-sleep wake)` →
